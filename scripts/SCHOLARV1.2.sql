...
-- Dumping data for table scholar-backoffice.contacts: ~1 rows (approximately)
...
-- Dumping data for table scholar-backoffice.general_accounts: ~1 rows (approximately)
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Every school has its own account';

-- Dumping data for table scholar-backoffice.school_account: ~0 rows (approximately)
